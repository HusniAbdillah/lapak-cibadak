...
2.  **Exploration:** They click on "Jelajahi Direktori" and are taken to `/direktori`. They filter the list by clicking the "Kerajinan" (Crafts) chip.
3.  **Profiling:** They select "Konveksi Tas Pak Aceng". The page loads instantly (SSG). They read the story about how Pak Aceng started in 2020.
...
4.  **Media Upload:** She takes a photo of her stall. The React component immediately streams this to Cloudinary and returns a secure `res.cloudinary.com/...` URL under the hood.
